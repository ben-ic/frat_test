defmodule FratTestV2Web.UserAuth do
  use FratTestV2Web, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_frat_test_v2_web_user_remember_me"
  @remember_me_options [sign: true, max_age: @max_age, same_site: "Lax"]
  @tracking_cookie "_frat_test_web_user_tracker"
  @tracking_cookie_options [sign: true, max_age: @max_age, same_site: "Lax"]
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      FratTestV2Web.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def maybe_add_tracker(conn, _opts) do
    ...
    |> put_session(:ip_address, to_string(:inet_parse.ntoa(conn.remote_ip)))
  end
  ...
  the current_user:
      ...
      defmodule FratTestV2Web.PageLive do
        use FratTestV2Web, :live_view

        on_mount {FratTestV2Web.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FratTestV2Web.UserAuth, :ensure_authenticated}] do
